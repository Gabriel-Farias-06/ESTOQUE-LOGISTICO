...
void recuperar_entrada_produto(); // vai procurar as entradas de produtos no arquivo que eles estao cadastrados
...
void salvar_funcionario(int i); // menu para cadastrar os novos funcionarios no arquivo
void salvar_produto(); // menu para cadastrar os novos produtos no arquivo
