...
void venda_produto()
{
    ...
    fflush(stdin);
    gets(produto_venda[produtos_vendidos].quantidade);
    ...
    {
        printf("Quantidade maior do que a descrita no estoque, atualmente no estoque ha %d unidades.\n", total_produtos_comprados - total_produtos_vendidos);
